            ...
            <ReactBootStrap.Row>
                ...
                <ReactBootStrap.Col xs={12} md={9}className="product-details-yellow">
                    ...
                    <div className="margin-left-42">
                        <ReactBootStrap.Row>
                            <span className="styled-text white heading-20">PRODUCT FORMS &amp; PACKAGING</span></ReactBootStrap.Row>
                            <br/>
                        <ReactBootStrap.Row className="full-width">
                        ...
                        <br/>
                        <ReactBootStrap.Row>
                            <span className="styled-text white heading-20">RECOMMENDED APPLICATIONS</span>
                        </ReactBootStrap.Row>
                        <br/>
                        <ReactBootStrap.Row>
